...
class FriendssesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friendss" do
    assert_difference("Friendss.count") do
      post friendsses_url, params: { friendss: { e_mail: @friendss.e_mail, firsst_name: @friendss.firsst_name, last_name: @friendss.last_name, phone: @friendss.phone, twitter: @friendss.twitter } }
    end
  ...
  test "should update friendss" do
    patch friendss_url(@friendss), params: { friendss: { e_mail: @friendss.e_mail, firsst_name: @friendss.firsst_name, last_name: @friendss.last_name, phone: @friendss.phone, twitter: @friendss.twitter } }
