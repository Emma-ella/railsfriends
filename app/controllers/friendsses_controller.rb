class FriendssesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @friendss.save
        format.html { redirect_to friendss_url(@friendss), notice: "Friendss was successfully created." }
  ...
  def update
    respond_to do |format|
      if @friendss.update(friendss_params)
        format.html { redirect_to friendss_url(@friendss), notice: "Friendss was successfully updated." }
  ...
  private
    ...
    def friendss_params
      params.require(:friendss).permit(:firsst_name, :last_name, :e_mail, :phone, :twitter)
    end
end
